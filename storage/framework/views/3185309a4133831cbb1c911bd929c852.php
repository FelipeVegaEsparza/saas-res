...
<?php $__env->startSection('title', 'Página no encontrada - ' . $companyName); ?>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-5 mb-lg-0 text-center text-lg-start">
                ...
                <div class="d-flex gap-3 justify-content-center justify-content-lg-start">
                    <a href="<?php echo e(url('/')); ?>" class="btn btn-primary btn-lg px-4">
                        <i class="ri ri-home-line me-2"></i>Volver al inicio
                    </a>
                    <a href="<?php echo e(route('landing.contact')); ?>" class="btn btn-outline-primary btn-lg px-4">
        ...
        <div class="row mt-5 pt-5">
            ...
            <div class="col-md-4 mb-3">
                <a href="<?php echo e(route('landing.index')); ?>" class="text-decoration-none">
            ...
            <div class="col-md-4 mb-3">
                <a href="<?php echo e(route('landing.tutorials')); ?>" class="text-decoration-none">
                    <div class="card border-0 shadow-sm h-100" style="transition: all 0.2s;">
                        <div class="card-body text-center p-4">
            ...
            <div class="col-md-4 mb-3">
                <a href="<?php echo e(route('landing.contact')); ?>" class="text-decoration-none">
                    <div class="card border-0 shadow-sm h-100" style="transition: all 0.2s;">
                        <div class="card-body text-center p-4">
...
<?php echo $__env->make('landing.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\saasres\resources\views/errors/404.blade.php ENDPATH**/ ?>