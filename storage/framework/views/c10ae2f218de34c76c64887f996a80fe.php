    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            <div class="app-brand demo" style="padding: 2rem 1.5rem; min-height: 120px; display: flex; align-items: center; justify-content: center;">
                <a href="<?php echo e(route('tenant.path.dashboard', ['tenant' => request()->route('tenant')])); ?>" class="app-brand-link" style="width: 100%; display: flex; justify-content: center;">
                    <?php
                        $restaurant = tenant()->restaurant();
                    ?>
                    <?php if($restaurant->logo_horizontal): ?>
                        <img src="<?php echo e(Storage::url($restaurant->logo_horizontal)); ?>" alt="<?php echo e($restaurant->name); ?>" style="max-height: 70px; max-width: 200px; object-fit: contain;">
                    <?php else: ?>
                        <span class="app-brand-text demo menu-text fw-semibold" style="font-size: 1.5rem;"><?php echo e($restaurant->name); ?></span>
                    <?php endif; ?>
                </a>
            ...
            <ul class="menu-inner py-1">
                <li class="menu-item <?php echo e(request()->routeIs('tenant.path.dashboard') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('tenant.path.dashboard', ['tenant' => request()->route('tenant')])); ?>" class="menu-link">
                ...
                <li class="menu-item <?php echo e(request()->routeIs('tenant.path.cash.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('tenant.path.cash.index', ['tenant' => request()->route('tenant')])); ?>" class="menu-link">
                        <i class="menu-icon icon-base ri ri-cash-line"></i>
                        <div>Caja</div>
                    </a>
                </li>

                <li class="menu-item <?php echo e(request()->routeIs('tenant.path.tables.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('tenant.path.tables.index', ['tenant' => request()->route('tenant')])); ?>" class="menu-link">
                        <i class="menu-icon icon-base ri ri-table-line"></i>
                        <div>Mesas</div>
                    </a>
                </li>

                <li class="menu-item <?php echo e(request()->routeIs('tenant.path.delivery.*') ? 'active' : ''); ?>">
                ...
                <li class="menu-item <?php echo e(request()->routeIs('tenant.path.products.*') || request()->routeIs('tenant.path.categories.*') ? 'active open' : ''); ?>">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <i class="menu-icon icon-base ri ri-restaurant-line"></i>
                        <div>Productos</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item <?php echo e(request()->routeIs('tenant.path.products.*') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('tenant.path.products.index', ['tenant' => request()->route('tenant')])); ?>" class="menu-link">
                                <div>Todos los Productos</div>
                            </a>
                        </li>
                        <li class="menu-item <?php echo e(request()->routeIs('tenant.path.categories.*') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('tenant.path.categories.index', ['tenant' => request()->route('tenant')])); ?>" class="menu-link">
                                <div>Categorías</div>
                            </a>
                        </li>
                    </ul>
                ...
                <li class="menu-item <?php echo e(request()->routeIs('tenant.path.stock.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('tenant.path.stock.index', ['tenant' => request()->route('tenant')])); ?>" class="menu-link">
                ...
                <li class="menu-item <?php echo e(request()->routeIs('tenant.path.statistics.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('tenant.path.statistics.index', ['tenant' => request()->route('tenant')])); ?>" class="menu-link">
                ...
                <li class="menu-item <?php echo e(request()->routeIs('tenant.path.users.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('tenant.path.users.index', ['tenant' => request()->route('tenant')])); ?>" class="menu-link">
                        <i class="menu-icon icon-base ri ri-user-line"></i>
                        <div>Usuarios</div>
                    </a>
                </li>

                <li class="menu-item <?php echo e(request()->routeIs('tenant.path.settings.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('tenant.path.settings.index', ['tenant' => request()->route('tenant')])); ?>" class="menu-link">
                ...
                <li class="menu-item">
                    <a href="<?php echo e(route('tenant.path.menu.index', ['tenant' => request()->route('tenant')])); ?>" class="menu-link" target="_blank">
            ...
            <nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme" id="layout-navbar">
                <div class="container-fluid">
                    ...
                    <div class="navbar-nav-right d-flex align-items-center w-100" id="navbar-collapse">
                        ...
                        <?php if(isset($shiftStats) && $shiftStats['has_active_session']): ?>
                            ...
                            <div class="d-flex align-items-center gap-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <strong style="font-size: 0.9rem;">$<?php echo e(number_format($shiftStats['shift_revenue'], 0)); ?></strong>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <strong style="font-size: 0.9rem;"><?php echo e($shiftStats['shift_delivery_count']); ?></strong>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <strong style="font-size: 0.9rem;"><?php echo e($shiftStats['shift_tables_served']); ?></strong>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <strong style="font-size: 0.9rem;">$<?php echo e(number_format($shiftStats['shift_avg_ticket'], 0)); ?></strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <div class="avatar avatar-online">
                                        <span class="avatar-initial rounded-circle bg-label-primary"><?php echo e(substr(auth()->user()->name, 0, 1)); ?></span>
                                    </div>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <form method="POST" action="<?php echo e(route('tenant.path.logout', ['tenant' => request()->route('tenant')])); ?>">
                                            <?php echo csrf_field(); ?>
                ...
                <footer class="content-footer footer bg-footer-theme">
                    <div class="container-xxl">
                        <div class="footer-container d-flex align-items-center justify-content-between py-4 flex-md-row flex-column">
                            <div class="text-body">
                                © <?php echo e(date('Y')); ?>, <?php echo e(tenant()->restaurant()->name); ?>
