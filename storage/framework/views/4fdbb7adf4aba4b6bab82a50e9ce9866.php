<?php $__env->startSection('title', 'Nueva Categoría - Admin'); ?>
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('admin.tutorial-categories.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.tutorial-categories.index')); ?>" class="btn btn-secondary">
                            Cancelar
                        </a>
                    </div>
                </form>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\saasres\resources\views/admin/tutorial-categories/create.blade.php ENDPATH**/ ?>