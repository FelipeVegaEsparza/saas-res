...
@section('title', $restaurant->name . ' - Pedidos Online')
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="mt-auto">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <h5 class="mb-0 text-primary">@price($product->price)</h5>
                                            </div>
                ...
                <div class="card-body">
                    ...
                    <div id="cartSummary" style="display: none;">
                        ...
                        <div class="d-flex justify-content-between mb-2" id="deliveryFeeRow" style="display: none;">
                            <span>Envío:</span>
                            <strong id="deliveryFeeAmount">@price($restaurant->delivery_fee ?? 0)</strong>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer flex-column align-items-stretch" id="mobileCartSummary" style="display: none !important;">
                ...
                <div class="d-flex justify-content-between mb-2" id="mobileDeliveryFeeRow" style="display: none;">
                    <span>Envío:</span>
                    <strong id="mobileDeliveryFeeAmount">@price($restaurant->delivery_fee ?? 0)</strong>
                </div>
                <div class="d-flex justify-content-between mb-3">
                    <strong>Total:</strong>
...
document.getElementById('checkoutForm').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('{{ route("tenant.path.online.store", ["tenant" => request()->route("tenant")]) }}', {
            method: 'POST',
            headers: {
