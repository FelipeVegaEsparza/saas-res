...
<div class="mb-4">
    ...
    <p class="text-muted">Gestiona la configuración de tu restaurante</p>
</div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="facebook" class="form-label"><i class="ri ri-facebook-fill"></i> Facebook</label>
                                <input type="url" class="form-control @error('facebook') is-invalid @enderror" id="facebook" name="facebook" value="{{ old('facebook', $restaurant->facebook) }}" placeholder="https://facebook.com/tu-restaurante">
                                @error('facebook')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="instagram" class="form-label"><i class="ri ri-instagram-fill"></i> Instagram</label>
                                <input type="url" class="form-control @error('instagram') is-invalid @enderror" id="instagram" name="instagram" value="{{ old('instagram', $restaurant->instagram) }}" placeholder="https://instagram.com/tu-restaurante">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="tiktok" class="form-label"><i class="ri ri-tiktok-fill"></i> TikTok</label>
                                <input type="url" class="form-control @error('tiktok') is-invalid @enderror" id="tiktok" name="tiktok" value="{{ old('tiktok', $restaurant->tiktok) }}" placeholder="https://tiktok.com/@tu-restaurante">
                                @error('tiktok')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="twitter" class="form-label"><i class="ri ri-twitter-x-fill"></i> X (Twitter)</label>
                                <input type="url" class="form-control @error('twitter') is-invalid @enderror" id="twitter" name="twitter" value="{{ old('twitter', $restaurant->twitter) }}" placeholder="https://x.com/tu-restaurante">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        @endif
                        <input type="file" class="form-control @error('menu_background_image') is-invalid @enderror" id="menu_background_image" name="menu_background_image" accept="image/*">
                        @error('menu_background_image')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                ...
                                <div class="col-md-4">
                                    <div class="form-check custom-option custom-option-basic {{ old('menu_color_scheme', $restaurant->menu_color_scheme) === $key ? 'checked' : '' }}">
                                        <label class="form-check-label custom-option-content" for="color_{{ $key }}">
                                            <input class="form-check-input" type="radio" name="menu_color_scheme" id="color_{{ $key }}" value="{{ $key }}" {{ old('menu_color_scheme', $restaurant->menu_color_scheme) === $key ? 'checked' : '' }}>
                    ...
                    <div class="alert alert-info mb-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <a href="{{ route('tenant.path.settings.download-qr', ['tenant' => request()->route('tenant')]) }}" class="btn btn-sm btn-primary" target="_blank">
                                    <i class="ri ri-download-line me-1"></i> Descargar QR
                                </a>
                                <a href="{{ url('/' . request()->route('tenant') . '/menu') }}" class="btn btn-sm btn-outline-primary" target="_blank">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="module_tables_enabled" name="module_tables_enabled" value="1" {{ old('module_tables_enabled', $restaurant->module_tables_enabled ?? true) ? 'checked' : '' }}>
                                        </div>
                                    </div>
                            ...
                            <div class="card border mb-3">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="module_delivery_enabled" name="module_delivery_enabled" value="1" {{ old('module_delivery_enabled', $restaurant->module_delivery_enabled ?? true) ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                    <ul class="list-unstyled mb-0 small text-muted">
        ...
        <div class="tab-pane fade" id="online" role="tabpanel">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="accepts_online_orders" name="accepts_online_orders" value="1" {{ old('accepts_online_orders', $restaurant->accepts_online_orders) ? 'checked' : '' }}>
                            <label class="form-check-label" for="accepts_online_orders">Aceptar Pedidos Online</label>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('delivery_fee') is-invalid @enderror" id="delivery_fee" name="delivery_fee" value="{{ old('delivery_fee', $restaurant->delivery_fee ?? 0) }}" min="0" step="0.01">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" class="form-control @error('min_order_amount') is-invalid @enderror" id="min_order_amount" name="min_order_amount" value="{{ old('min_order_amount', $restaurant->min_order_amount ?? 0) }}" min="0" step="0.01">
                                </div>
                    ...
                    <div class="alert alert-info mb-0">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" value="{{ url('/' . request()->route('tenant') . '/order') }}" readonly id="onlineOrderUrl">
