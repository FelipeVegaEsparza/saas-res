    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            <div class="app-brand demo" style="padding: 2rem 1.5rem; min-height: 120px; display: flex; align-items: center; justify-content: center;">
                <a href="{{ route('admin.dashboard') }}" class="app-brand-link" style="width: 100%; display: flex; justify-content: center; flex-direction: column; align-items: center;">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{ request()->routeIs('admin.tutorial-categories.*') ? 'active' : '' }}">
                    <a href="{{ route('admin.tutorial-categories.index') }}" class="menu-link">
                        <i class="menu-icon icon-base ri ri-folder-line"></i>
                        <div>Categorías</div>
                    </a>
                </li>

                <li class="menu-item {{ request()->routeIs('admin.tutorials.*') ? 'active' : '' }}">
                ...
                <li class="menu-item">
                    <a href="{{ route('landing.index') }}" class="menu-link" target="_blank">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <div class="avatar avatar-online">
                                        <span class="avatar-initial rounded-circle bg-label-primary">{{ substr(auth()->guard('admin')->user()->name, 0, 1) }}</span>
                                    </div>
                                </a>
