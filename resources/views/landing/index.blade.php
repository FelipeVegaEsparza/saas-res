    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-7 mb-5 mb-lg-0">
                <h1 class="display-4 fw-bold mb-4">Aumenta tus ventas y reduce costos operativos hasta un 40%</h1>
                <p class="lead mb-4">Sistema profesional de gestión para restaurantes. Control total de mesas, pedidos, inventario y finanzas en una sola plataforma. Implementación en 24 horas.</p>
            ...
            <div class="col-lg-5">
                <div class="card border-0 shadow-lg">
                    <div class="card-body p-4">
                        <h5 class="fw-bold mb-4">Beneficios Inmediatos</h5>
                        <ul class="list-unstyled mb-0">
                            <li class="mb-3 d-flex">
                                <i class="ri ri-check-line text-success me-2 mt-1"></i>
                                <span><strong>Reduce errores</strong> en pedidos hasta 95%</span>
                            </li>
                            <li class="mb-3 d-flex">
                                <i class="ri ri-check-line text-success me-2 mt-1"></i>
                                <span><strong>Aumenta rotación</strong> de mesas en 30%</span>
                            </li>
                            <li class="mb-3 d-flex">
                                <i class="ri ri-check-line text-success me-2 mt-1"></i>
                                <span><strong>Control total</strong> de inventario y mermas</span>
                            </li>
                            <li class="mb-3 d-flex">
                                <i class="ri ri-check-line text-success me-2 mt-1"></i>
                                <span><strong>Reportes en tiempo real</strong> desde cualquier lugar</span>
                            </li>
                            <li class="mb-0 d-flex">
                                <i class="ri ri-check-line text-success me-2 mt-1"></i>
                                <span><strong>Pedidos online</strong> integrados sin comisiones</span>
                            </li>
                        </ul>
                    </div>
                </div>
...
<section class="py-5 bg-light">
    <div class="container py-5">
        <div class="text-center mb-5">
            <h2 class="fw-bold mb-3">¿Te identificas con estos problemas?</h2>
            <p class="text-muted">Estos son los desafíos más comunes que enfrentan los restaurantes</p>
        </div>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        <div class="text-danger mb-3">
                            <i class="ri ri-error-warning-line" style="font-size: 2.5rem;"></i>
                        </div>
                        <h5 class="mb-3">Errores en Pedidos</h5>
                        <p class="text-muted mb-0">Pedidos mal tomados, productos equivocados, clientes insatisfechos y pérdida de dinero.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        <div class="text-warning mb-3">
                            <i class="ri ri-time-line" style="font-size: 2.5rem;"></i>
                        </div>
                        <h5 class="mb-3">Servicio Lento</h5>
                        <p class="text-muted mb-0">Mesas esperando, clientes impacientes, pérdida de rotación y ventas.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        <div class="text-info mb-3">
                            <i class="ri ri-question-line" style="font-size: 2.5rem;"></i>
                        </div>
                        <h5 class="mb-3">Sin Control</h5>
                        <p class="text-muted mb-0">No sabes cuánto vendes realmente, qué productos funcionan o dónde pierdes dinero.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        <div class="text-secondary mb-3">
                            <i class="ri ri-money-dollar-circle-line" style="font-size: 2.5rem;"></i>
                        </div>
                        <h5 class="mb-3">Costos Altos</h5>
                        <p class="text-muted mb-0">Mermas, robos, desperdicio de inventario y gastos operativos fuera de control.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="text-center mt-5">
            <p class="lead mb-0"><strong>Nuestro sistema resuelve estos problemas desde el primer día.</strong></p>
        </div>
    </div>
</section>
